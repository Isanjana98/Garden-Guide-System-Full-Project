...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            ...
            ?>
            <h1 class="h3 mb-4 text-gray-800">View Researchers Registrations</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Full Name And Job Position</th>
                                        <th scope="col">Already Deal With Our Garden </th>
                                        <th scope="col">Phone Number</th>
                                        <th scope="col">Personnel Address</th>
                                        <th scope="col">How Much You Can Invest in Your Research</th>
