<section class="py-5 bg-gray">
    <div class="container py-5">
        <h2 class="lined mb-4">Researcher Registration</h2> <!-- needs 600x400 image -->
        <div class="row">
            <div class="col-8 pt-3">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-4 field-required">
                        <label for="givenname">Full Name And Job Position</label>
                    ...
                    <div class="mb-4 field-required">
                        <label for="select_animal">Already Deal With Our Garden </label>
                    ...
                    <div class="mb-4 field-required">
                        <label for="s_phone_number">Phone Number</label>
                    ...
                    <div class="mb-4 field-required">
                        <label for="s_client_address">Personnel Address</label>
                    ...
                    <div class="mb-4 field-required">
                        <label for="s_business_type">Research Type</label>
                    ...
                    <div class="mb-4 field-required">
                        <label for="s_yearly_revenue">How Much You Can Invest in Your Research</label>
                    ...
                    <button class="btn btn-primary btn-lg btn-block" type="submit" name="submit"><?= isset($_GET['sponsor_id']) ? "Update Details" : "Apply for Researcher In Our Garden"  ?></button>
            </div>
        </div>
    </div>
</section>