<section class="py-5 bg-gray">
    <div class="container py-5">
        <h2 class="lined mb-4">Book Tickets <i>For Overseas Tourist</i>  <br><br> Opening 365 Days:8.30am to 5.00pm</h2> <!-- needs 600x400 image -->
        <div class="row">
            <div class="col-8">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>Foreign Adult (Elder than 12)</td>
                            <td>$6.00</td>
                        </tr>
                        <tr>
                            <td>Foreign Student (Must have proof)</td>
                            <td>$3.00</td>
                        </tr>
                        <tr>
                            <td>Foreign Child (5 to 12 Years)</td>
                            <td>$2.00</td>
                        </tr>
                    </tbody>
                </table>
