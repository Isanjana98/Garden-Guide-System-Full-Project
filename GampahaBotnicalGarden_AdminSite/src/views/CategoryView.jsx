...
function CategoryView() {
    ProtectiveRoute()
    const thArray = ["CATEGORY ID","CATEGORY NAME" ,"PLANT COUNT","ACTION"];
    ...
    const handleDelete = (id) => {
        ...
        axios.delete(`${BASE_URL}/garden/dashboard/delete_category`, {
            data: {id: id}, headers: {
    ...
    return (
        <>
            ...
            <Modal size="xl" show={show}  aria-labelledby="contained-modal-title-vcenter" onHide={handleClose} centered>
                ...
                <Modal.Body>
                    <CategoryViewObj obj={selectedCategory} isEditable={isEditable} handleClose={handleClose} isSave = {isSave} refresh = {setRefresh}></CategoryViewObj>
                </Modal.Body>
